...
export type PowerFetchResult = {
    ...
    flavor: string | null,
    effect: string | null,
    ref_weapon_id: string | null,
    ref_armor_id: string | null,
    ref_faq_id: string | null,
    ref_info_id: string | null,
    other_ver_id: string | null,
    rel_power_id: string | null,
    rel_weapon_id: string | null,
    rel_armor_id: string | null,
...
export type GeneralFetchResult = {
    id: string,
    supplement: string,
    category: string,
    name: string,
