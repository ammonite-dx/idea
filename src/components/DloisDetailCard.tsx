...
export default function DloisDetailCard ({ dlois }: { dlois: Dlois }) {
    return (
      <Card>
        ...
        <CardBody>
          ...
          <div className="my-2">
            <WrappedText text={dlois.flavor} />
          </div>
          <div className="my-2">
            <span className="font-bold">●解説</span>
            <WrappedText text={dlois.description} />
          </div>
          <div className="my-2">
            {dlois.rec && <CardBodyRow><PropDict name="REC" value={dlois.rec}/></CardBodyRow>}
            {dlois.rec ? <span className="font-bold">●通常効果</span> : <span className="font-bold">●効果</span>}
            <WrappedText text={dlois.effect}/>
